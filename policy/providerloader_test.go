...
// Test ProviderPolicy.CreateVerifierWithHTTPClient with a custom HTTP client.
func TestProviderPolicy_CreateVerifierWithHTTPClient(t *testing.T) {
	policy := &ProviderPolicy{}
	policy.AddRow(ProvidersRow{
		Issuer:           "https://accounts.google.com",
		ClientID:         "test-google",
...
// Test ProviderPolicy.CreateVerifierWithHTTPClient accepts nil HTTP client.
func TestProviderPolicy_CreateVerifierWithHTTPClient_Nil(t *testing.T) {
	policy := &ProviderPolicy{}
	policy.AddRow(ProvidersRow{
		Issuer:           "https://accounts.google.com",
		ClientID:         "test-google",
