#!/bin/bash
# Script to test OpenSSH version detection in a Debian container
# This validates the command used in main.go for detecting OpenSSH version on Debian-based systems

set -e  # Exit immediately if a command fails

echo "=== Starting Debian container test ==="
